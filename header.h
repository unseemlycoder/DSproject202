...
//Function Headers
struct Graph* createGraph(int); //Function to allocate memory to Graph structure
struct node* createNode(int); //Function to allocate memory to Node structure
int addEdge(struct Graph*, int, int); //Function to add edge
void delEdge(struct Graph*, int, int); //Function to delete an edge
void printGraph(struct Graph*); //Function to print Graph
...
void genMat_path(struct Graph*,int); //Function to generate matrix and find shortest path using Dijkstra's algorithm
